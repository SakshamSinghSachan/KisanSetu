  ...
  return (
    <div className="min-h-screen overflow-hidden bg-gray-950">
        ...
        <motion.div style={{ y: y1, opacity, scale }} className="relative z-10 max-w-7xl mx-auto px-4 py-32">
          <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, ease: "easeOut" }} className="text-center">
            ...
            <motion.div 
              ...
              className="inline-flex items-center space-x-2 bg-gray-800/50 backdrop-blur-md border border-gray-700/50 rounded-full px-4 py-2 mb-8"
            >
              <span className="w-2 h-2 bg-primary-400 rounded-full animate-pulse"></span>
              <span className="text-gray-300 text-sm font-medium">Farm to Consumer Digital Marketplace</span>
            </motion.div>

            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold text-white mb-6 font-heading leading-tight">
              Bridging Farmers
              <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-400 via-primary-300 to-saffron-400">
                Directly
              </span>
              <br />
              to Your Table
            ...
            <motion.p 
              ...
              className="text-xl md:text-2xl text-gray-400 max-w-3xl mx-auto mb-12 text-balance leading-relaxed"
            >
            ...
            >
              <Link to="/register" className="group bg-gradient-to-r from-primary-500 to-primary-600 text-white px-8 py-4 rounded-2xl font-bold text-lg hover:from-primary-600 hover:to-primary-700 transition-all duration-300 shadow-2xl shadow-primary-500/30 hover:shadow-primary-500/50 transform hover:-translate-y-1 flex items-center space-x-3">
                <span>Start Trading</span>
                <HiArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
              </Link>
              <Link to="/marketplace" className="group border border-gray-600 text-white px-8 py-4 rounded-2xl font-bold text-lg hover:bg-white/5 transition-all duration-300">
                Explore Marketplace
              </Link>
            </motion.div>
          </motion.div>
          ...
          <motion.div 
            ...
            className="mt-20"
          >
            <div className="bg-gray-800/50 backdrop-blur-xl rounded-3xl p-8 md:p-10 border border-gray-700/50">
      ...
      <section className="py-24 px-4 bg-gray-900">
        <div className="max-w-7xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-16">
            <span className="inline-block text-primary-400 font-semibold text-sm tracking-wider uppercase mb-4">Why Choose Us</span>
            <h2 className="text-4xl md:text-5xl font-bold mb-6 font-heading text-white">
              Why <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-400 to-saffron-400">KisanSetu</span>?
            </h2>
            <p className="text-gray-400 max-w-2xl mx-auto text-lg">A complete digital ecosystem connecting farmers directly with consumers, powered by AI and smart logistics.</p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, i) => (
              <motion.div 
                ...
                className="group relative bg-gray-800/50 rounded-3xl p-8 border border-gray-700/50 hover:border-gray-600/50 transition-all duration-500 overflow-hidden"
              >
                <div className="absolute inset-0 bg-gradient-to-br from-primary-500/5 to-saffron-500/5 opacity-0 group-hover:opacity-100 transition-all duration-500"></div>
      ...
      <section className="py-24 px-4 bg-gray-950 relative overflow-hidden">
        <div className="absolute inset-0">
          <div className="absolute top-0 left-0 w-96 h-96 bg-saffron-500/5 rounded-full filter blur-3xl -translate-x-1/2 -translate-y-1/2"></div>
          <div className="absolute bottom-0 right-0 w-96 h-96 bg-primary-500/5 rounded-full filter blur-3xl translate-x-1/2 translate-y-1/2"></div>
        </div>
        ...
        <div className="max-w-7xl mx-auto relative">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
              ...
              <h2 className="text-4xl md:text-5xl font-bold mb-8 font-heading text-white">How It <span className="text-saffron-400">Works</span></h2>
              <div className="space-y-8">
                {[
                  ...
                  >
                    ...
                    <div>
                      <h4 className="font-semibold text-xl mb-2 text-white group-hover:text-saffron-400 transition-colors">{item.title}</h4>
                ...
                <div className="grid grid-cols-2 gap-4">
                  {[
                    ...
                    <motion.div 
                      ...
                      className={`bg-gradient-to-br ${item.color} backdrop-blur-sm rounded-2xl p-6 text-center border border-gray-700/30 hover:border-gray-600/50 transition-all duration-300`}
                    >
                      <div className="text-5xl mb-3">{item.emoji}</div>
                      <div className="font-semibold text-lg mb-1 text-white">{item.title}</div>
      ...
      <section className="py-24 px-4 bg-gray-900">
        <div className="max-w-7xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-16">
            <span className="inline-block text-primary-400 font-semibold text-sm tracking-wider uppercase mb-4">Testimonials</span>
            <h2 className="text-4xl md:text-5xl font-bold mb-6 font-heading text-white">What Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-400 to-saffron-400">Users</span> Say</h2>
            <p className="text-gray-400 max-w-2xl mx-auto text-lg">Join thousands of satisfied farmers and consumers</p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, i) => (
              <motion.div 
                ...
                viewport={{ once: true }}
                transition={{ delay: i * 0.15 }}
                className="bg-gray-800/50 rounded-3xl p-8 border border-gray-700/50 hover:border-gray-600/50 transition-all duration-500 relative overflow-hidden group"
              >
        ...
        <div className="max-w-4xl mx-auto text-center relative">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <Link to="/marketplace" className="text-white border-2 border-white/40 px-10 py-5 rounded-2xl font-bold text-lg hover:bg-white/10 transition-all duration-300">
                Explore Products
              </Link>
            </div>
      ...
      {/* Footer */}
      <footer className="bg-gray-950 text-white pt-16 pb-8 px-4 border-t border-gray-800">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              <h4 className="font-semibold text-lg mb-6 text-white">For Farmers</h4>
              <ul className="space-y-3">
            ...
            <div>
              ...
              <div className="flex">
                <input type="email" placeholder="Your email" className="flex-1 bg-gray-800 border border-gray-700 rounded-xl px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-primary-500" />
